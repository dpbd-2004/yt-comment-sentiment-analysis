...
docker pull 361753377361.dkr.ecr.eu-north-1.amazonaws.com/yt-chrome-plugin:latest
...
docker run -d -p 80:5000 --name yt-app 361753377361.dkr.ecr.eu-north-1.amazonaws.com/yt-chrome-plugin:latest
